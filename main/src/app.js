...
typeorm_1.createConnection(ormconfig_1.default).then(function (db) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume('product_deleted', function (message) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            adminId = parseInt(message.content.toString());
                            return [4 /*yield*/, productRepository.deleteOne({ admin_id: adminId })];
                        case 1:
                            _a.sent();
            ...
            app.get('/api/products', function (req, response) { return __awaiter(void 0, void 0, void 0, function () {
                var products;
                return __generator(this, function (_a) {
                    switch (_a.label) {
            ...
            app.post('/api/products/:productId/like', function (req, response) { return __awaiter(void 0, void 0, void 0, function () {
                var product, res;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOne({ admin_id: parseInt(req.params.productId) })];
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, axios_1.default.post("http://localhost:8000/api/products/" + product.admin_id + "/likes")];
                        case 2:
                            res = _a.sent();
                            product.like++;
                            return [4 /*yield*/, productRepository.save(product)];
