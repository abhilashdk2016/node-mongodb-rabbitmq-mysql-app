...
typeorm_1.createConnection(ormconfig_1.default).then(function (db) {
    ...
    amqp.connect('amqp://localhost:5672', function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            app.get('/api/products/:productId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOne(req.params.productId)];
                        case 1:
                            product = _a.sent();
            ...
            app.delete('/api/products/:productId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var product, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOne(req.params.productId)];
            ...
            app.post('/api/products/:productId/likes', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var product, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOne(req.params.productId)];
